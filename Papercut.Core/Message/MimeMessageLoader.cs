                ...
                (o) =>
                {
                    ...
                    try
                    {
                        var message = _mimeMessageCache.GetOrSet(
                            ...
                            () =>
                            {
                                _logger.Verbose("Getting Message Data from Cached Message Repository", messageEntry);
                                ...
                                {
                                    _logger.Verbose("MimeMessage Load for {@MessageEntry}", messageEntry);
                                    mimeMessage = MimeMessage.Load(ParserOptions.Default, ms, disposable.Token);
                                }
