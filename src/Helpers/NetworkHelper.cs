...
namespace Papercut.Helpers
{
    ...
    public static class NetworkHelper
    {
        ...
        public static IEnumerable<string> GetIPAddresses()
        {
            ...
            using (ManagementObjectCollection mgtObjects = new ManagementObjectSearcher(NetworkAdapterQuery).Get())
            {
                var addresses =
                ...
                foreach (var ipAddress in addresses)
                {
                    ...
                    {
                        ips.AddRange((string[])ipAddress.Value);
                    }
                    else
                    {
                        ips.Add(ipAddress.Value.ToString());
                    }
                }
            }
