...
namespace Papercut.Events
{
    ...
    {
        private readonly IEventAggregator _uiEventAggregator;
        ...
        public EventPublishAll(
            ...
            : base(scope)
        {
            this._uiEventAggregator = uiEventAggregator;
        }
        ...
        public override async Task PublishAsync<T>([NotNull] T eventObject)
        {
            ...
            await this._uiEventAggregator.PublishOnUIThreadAsync(eventObject);
        }
        ...
        protected override async Task ExecuteHandler<T>(T eventObject, IEventHandler<T> @event)
        {
            ...
            {
                await PlatformProvider.Current.OnUIThreadAsync(async () => await base.ExecuteHandler(eventObject, @event));
            }
            else
            {
